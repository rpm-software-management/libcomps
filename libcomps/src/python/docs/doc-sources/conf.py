...
import ctypes
clibcomps = ctypes.cdll.LoadLibrary("/home/jluza/_dmach/libcomps-build3/src/libcomps.so.0.1.6")
os.environ['LD_LIBRARY_PATH'] = "%s" % "/home/jluza/_dmach/libcomps-build3/src"
print os.environ['LD_LIBRARY_PATH'] 

sys.path.insert(0, os.path.abspath("/home/jluza/_dmach/libcomps-build3/src/python/src/python3"))
import libcomps
